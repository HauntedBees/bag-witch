...
## This plays when you equip it.
@export_custom(SRP_HINT.RESOURCE_PATH, "AudioStream") var equip_sound: String

## This plays when you use it.
@export_custom(SRP_HINT.RESOURCE_PATH, "AudioStream") var usage_sound: String

## This plays when you reload it.
@export_custom(SRP_HINT.RESOURCE_PATH, "AudioStream") var reload_sound: String
